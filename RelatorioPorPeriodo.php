...
Texto::criarTitulo("Relatório: Chamados por Período");

$busca = new Busca();
$busca->validarPost($_POST);

$dataGrid = new DataGrid(array('Data de Inclusão',$_SESSION['config']['usuario'] .' Solicitante','Número do chamado','Descrição','Status'));
...
$dataGrid->exportarExcel('RelatorioPorPeriodo','listarChamadoPorPeriodo',1);
...
try 
{
	$dataGrid->setDados($busca->listarChamadoPorPeriodo());
