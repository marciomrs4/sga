...
<script type="text/javascript" src="../<?php echo($_SESSION['projeto']);?>/jscript/GraficoQtdChamadoPorUsuario.php"></script>


<div id="containerAqueleDoGrafico" style="width:100%; height:400px;"></div>
