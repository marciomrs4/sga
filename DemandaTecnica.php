    ...
    <body>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3 class="panel-title" align="center">Demanda de TI</h3>
            </div>
            <div class="panel-body">
                <form role="form-inline" id="formsolicitacaoacesso" method="post" action="action/demandatecnica.php" enctype="multipart/form-data">
                    <div class="row">

                        <div class="col-xs-3">
                            <label class="control-label" for="area">Nome da DT:</label>
                            <input type="text" name="nome_dt" value=""
                                   class="form-control" id="nome_dt" placeholder="Nome da demanda técnica" required>
                        </div>

                        <div class="col-xs-6">
                            <label class="control-label" for="nome_solicitante">Data:</label>
                            <input type="text" name="data_dt" class="form-control" value="<?php echo date('d-m-Y'); ?>" placeholder="Nome do solicitante" required>
                        </div>
